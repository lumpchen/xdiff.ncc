...
public class TilingPaint implements Paint
{
    ...
    private final PDFPageContentDrawer drawer;
     ...
     * pattern
     */
    TilingPaint(PDFPageContentDrawer drawer, PDTilingPattern pattern, AffineTransform xform)
            throws IOException
    {
        this.drawer = drawer;
     ...
     */
    TilingPaint(PDFPageContentDrawer drawer, PDTilingPattern pattern, PDColorSpace colorSpace,
